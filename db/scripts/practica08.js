...
db.cuestionario_previo.insertMany([
  ...
  },
  {
    ...
    question:
      "Enuncie tres aplicaciones de la ley de Charles",
  ...
  },
  {
    ...
    question_type: "answer_list",
    question:
     "Mencione 10 gases a los que puede aplicarse la ley de Charles.",
    needed_answers: ["textarea", "textarea", "textarea",
  ...
  },
  {
    ...
    question:
      "Dibuje una isoterma para un gas en un diagrama (V-P).",
  },
  {
    practica_id: practica8,
    question_type: "multiple_question",
    ...
    media: "<table class='w-full border border-white'> <tr> <td class='border border-white'>r</td><td class='border border-white'>4.8</td><td class='border border-white'>9.6</td><td class='border border-white'>14.4</td><td class='border border-white'>19.2</td><td class='border border-white'>24.0</td><td class='border border-white'>28.8</td><td class='border border-white'>33.6</td></tr><tr> <td class='border border-white'>s</td><td class='border border-white'>15.43</td><td class='border border-white'>19.35</td><td class='border border-white'>23.23</td><td class='border border-white'>27.15</td><td class='border border-white'>31.03</td><td class='border border-white'>34.95</td><td class='border border-white'>38.83</td></tr></table>",
    fields: [
      {
        _id: ObjectId(),
        field: "La pendiente",
