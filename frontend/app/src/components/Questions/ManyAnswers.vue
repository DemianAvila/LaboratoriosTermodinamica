<template>
  ...
  <div class="overflow-x-scroll overflow-y-scroll" v-html="object.media"></div>
  <div>
    <div
      class="mt-2 flex flex-row items-center justify-center"
      v-for="(answer, index) in prop_answers"
      :key="index"
    >
      <textarea
        class="w-[90%]"
      ...
      <math-field
        class="w-[90%] bg-white text-black"
      ...
      <button class="w-[10%]" @click="deleteIndex(index)">
        <i class="fa-solid fa-trash"></i>
      </button>
    </div>
    <button class="w-full my-2 mb-5" @click="addAnswer">
